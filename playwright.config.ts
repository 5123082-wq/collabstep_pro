...
export default defineConfig({
  ...
  webServer: {
    command:
      "sh -c 'pnpm --filter @collabverse/web start --hostname 127.0.0.1 --port 3000'",
    ...
    env: {
      ...
      NEXT_PUBLIC_FEATURE_WORKSPACE_DASHBOARD: '1',
      NEXT_PUBLIC_FEATURE_TASKS_WORKSPACE: '1',
      NEXT_PUBLIC_FEATURE_BUDGET_LIMITS: '1',
      NEXT_PUBLIC_FEATURE_FINANCE_AUTOMATIONS: '1',
      HOSTNAME: '127.0.0.1',
      PORT: '3000'
    }
  }
