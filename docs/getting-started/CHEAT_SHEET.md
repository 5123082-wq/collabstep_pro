...
- 📚 [QUICK_SETUP_GUIDE.md](./QUICK_SETUP_GUIDE.md) - Полная инструкция
- 🌐 Web: http://localhost:3000
- 📡 WebSocket: ws://localhost:8080

> **Примечание:** Файлы `QUICK_START.md` и `PERFORMANCE_FIX.md` были удалены как устаревшие. Используйте `QUICK_SETUP_GUIDE.md` для актуальных инструкций по запуску.
