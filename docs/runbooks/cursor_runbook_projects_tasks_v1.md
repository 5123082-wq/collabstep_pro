...
> Цель: Один файл, который Cursor выполнит последовательно — обновит документацию (03-Technical-Plan.md, platform/overview.md, PLAN.md), создаст каркас раздела и подготовит серию PR по этапам A→F. Вставки даны текстом. Следуй шагам строго.
...
### 1.2 Обновить platform/overview.md — UX‑потоки и сценарии

**Действие:** открыть `platform/overview.md`, перейти в конец файла и **вставить блок целиком** ниже.
...
### Этап A — Навигация и каркас (Roadmap)
...
### Этап A — Навигация и каркас (Реализация)
...
### Этап C — Задачи (Board/List/Calendar) (Реализация)
...
### Промпт 2 — Обновить platform/overview.md

```text
Открой platform/overview.md. В конец файла вставь раздел
