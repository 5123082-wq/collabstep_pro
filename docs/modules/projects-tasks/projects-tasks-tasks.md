...
**Ограничение people picker / assignee contract:**

- В assignee picker попадают только участники проекта
- Если нужный человек зарегистрирован на платформе, но ещё не состоит в проекте, его сначала нужно добавить в команду проекта через PM people picker
- Это сделано намеренно: проект остаётся каноническим access boundary для task assignment
