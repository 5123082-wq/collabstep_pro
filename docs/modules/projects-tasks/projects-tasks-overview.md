...
### Сценарий 6: Поиск людей и сбор команды проекта

1. Пользователь открывает проект и нажимает "Команда"
2. Ищет зарегистрированного пользователя по имени, email или должности
3. Видит статус кандидата: уже в проекте, в команде организации или только на платформе
4. Добавляет человека в проект с ролью `admin`, `member` или `viewer`
5. После этого человек появляется в списке исполнителей задач проекта
...
| Teams         | Команды проектов и организаций. Участники, роли, people picker, прямое добавление existing users, приглашения | [teams.md](./projects-tasks-teams.md)                 | ✅ stable  |
