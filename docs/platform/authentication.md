...
- На регистрации есть выбор типа аккаунта: personal или business.
- При регистрации создаётся организация выбранного типа:
  - personal — всегда создаётся персональная организация (имя = имя пользователя).
  - business — требуется название организации.
  - invite-регистрация всегда создаёт personal-организацию.
